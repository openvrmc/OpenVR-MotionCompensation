...
D:\Programme\Qt\5.14.1\msvc2017_64\bin\windeployqt.exe --dir qtdata --libdir . --plugindir qtdata/plugins --qmldir res/qml OpenVR-InputEmulatorOverlay.exe --release
